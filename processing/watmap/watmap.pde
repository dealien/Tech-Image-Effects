...
// image sets; select the pattern to be used by changing the value of "set"
...
final static String file_ext = ".jpg";
final static int pattern_init = 3;
final static int pattern_length = 8;
final static int pattern_size = 4;
